...
<link href="catalog/view/theme/<?php echo $mytemplate; ?>/stylesheet/stylesheet.css?ver=2.1" rel="stylesheet" />
...
<div class="box-cms-content">
 	<div class="today-content content">
		


<!--<img src="../upload/image/catalog/images1(1).png"><img border="0" width="130" height="60" alt="Tech Source" src="../upload/image/catalog/weeklyflyer.gif">onfocus="this.blur()" onclick="NewWindow(this.href,'Flyer','1010','600','yes','center');return false"
<a href="#">Today's Offer</a><?php echo $offer_data['offer_title'];?>-->
	<ul class="main-navigation">
	<?php
	foreach($offer_catalogs as $offer_data) {
	$file=$offer_data['file_name'];
	...
	echo
					...
					'<li class="thumbnail_data">';?>
					
					<a href="../upload/upload/<?php echo $file;?>" onclick="NewWindow(this.href,'Flyer','1010','600','yes','center');return false" ><img border="0" width="200" height="50" alt="Flyer" src="../upload/image/catalog/demo/images/aaaa.png"></a>
					<?php echo '</li>
	...
	<div class="main-menu container" id="cms-menu">
        <ul class="main-navigation">
            ...
            <li class="level0"><a href="<?php echo $sitemap; ?>"><?php echo $text_sitemap; ?></a></li>-->
             <li class="level0"><a href="<?php echo $home; ?>">HOME</a></li>   
