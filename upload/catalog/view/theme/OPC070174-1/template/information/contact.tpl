          ...
          <div class="row contact-info">
			...
			<div class="right">
				<div class="map">
					...
					?><?php */?>
				<script type="text/javascript" src="http://www.webestools.com/google_map_gen.js?lati=43.830905&long=-79.266663&zoom=4&width=350&height=200&mapType=normal&map_btn_normal=yes&map_btn_satelite=yes&map_btn_mixte=yes&map_small=yes&marqueur=yes&info_bulle="></script>
				</div>
			</div>
            <div class="col-sm-3">
              <?php if ($open) { ?>
